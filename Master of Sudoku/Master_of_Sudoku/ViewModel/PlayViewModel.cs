...
namespace Master_of_Sudoku.ViewModel
{
    public class PlayViewModel:BaseViewModel
    {
        ...
        {
            get { return _sudoku.Time+_timeSpan; }
        ...
        public bool CheckForResult(int value) 
        {
        ...
        private async Task EndedGame()
        {
            ...
            await _pageService.DisplayAlert("Finish!","You Win! Your Score is: " + Score, "Back to MENU");
        ...
        private int AddPoint()
        {
            ...
            // check block
            var b = GetBlock2(_sudoku.Board, _rowIndex,_columnIndex);
            if (!b.Any(n=>n==0))
            {
        ...
        public static int[] GetBlock2(int[,] arr, int row, int col)
        {
            var array = new int[9];
            int r = row - row % 3;
            int c = col - col % 3;
